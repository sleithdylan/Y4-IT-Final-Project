...
<head>
	<!-- Basic Page Needs -->
	<title>Attendances | CloseApart</title>
	<meta charset="utf-8">
					...
					<div class="card">
						<div class="card-header bg-transparent">
							<div class="row align-items-center">
								<div class="col">
									<h3 class="mb-0">Your Students Attendances</h3>
								</div>
							</div>
						</div>
						<div class="card-body">
								...
								<table id="sorttable" class="table align-items-center table-flush hover stripe" style="border: none;">
									<thead class="thead-light">
										<tr>
											...
											<th scope="col">Attendance (Explained)</th>
											<th scope="col">Attendance (Unexplained)</th>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<?php if($list['attendance'] == ""): ?>
												<?php echo '0' . '%' ?>
												<?php else: ?>
												<?php echo $list['attendance'] . '%' ?>
												<?php endif; ?>
											</td>
											<td>
												<?php if($list['attendance_explained'] == ""): ?>
												<?php echo '0' . '%' ?>
												<?php else: ?>
												<?php echo $list['attendance_explained'] . '%' ?>
												<?php endif; ?>
											</td>
											<td>
												<?php if($list['attendance_unexplained'] == ""): ?>
												<?php echo '0' . '%' ?>
												<?php else: ?>
												<?php echo $list['attendance_unexplained'] . '%' ?>
												<?php endif; ?>
											</td>
											<td>
												<div class="d-flex">
