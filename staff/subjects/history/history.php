...
// SELECT Query
$query = "SELECT * FROM students JOIN classes USING(class_id) JOIN subjects USING(student_email) WHERE subject_name='History' AND staff_email='" . $staffData['staff_email'] . "' OR subject_name='History' AND staff_email='" . $_SESSION['email'] . "' ORDER BY student_id ASC";
...
<head>
	<!-- Basic Page Needs -->
	<title>History Class | CloseApart</title>
	<meta charset="utf-8">
					...
					<div class="card">
						<div class="card-header bg-transparent">
							<div class="row align-items-center">
								<div class="col">
									<h3 class="mb-0">History Class</h3>
								</div>
							</div>
						</div>
						<div class="card-body">
