...
if (isset($_POST['profile'])) {
  ...
  WHERE subject_name='History' AND student_id = {$id}";
...
// SELECT Query
$query = "SELECT * FROM students JOIN subjects USING(student_email) WHERE subject_name='History' AND student_id = {$id}";
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												<label class="form-control-label" for="grade">History Grade</label>
											...
											<div class="form-group">
												<label class="form-control-label" for="gpa">History GPA</label>
												<input type="text" class="form-control" id="gpa" name="gpa" placeholder="GPA, e.g. 4.5"
													value="<?php echo $lists['subject_gpa']; ?>" required>
											</div>
											<div class="form-group">
												<label class="form-control-label" for="attendance">History Attendance</label>
