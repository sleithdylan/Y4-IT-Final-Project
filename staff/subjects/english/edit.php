...
if (isset($_POST['profile'])) {
  ...
  WHERE subject_name='English' AND student_id = {$id}";
...
// SELECT Query
$query = "SELECT * FROM students JOIN subjects USING(student_email) WHERE subject_name='English' AND student_id = {$id}";
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												<label class="form-control-label" for="grade">English Grade</label>
												<input type="text" id="grade" name="grade" class="form-control" placeholder="Grade, e.g. 85"
													value="<?php echo $lists['subject_grade']; ?>" required>
											</div>
											<div class="form-group">
												<label class="form-control-label" for="gpa">English GPA</label>
												<input type="text" class="form-control" id="gpa" name="gpa" placeholder="GPA, e.g. 4.5"
													value="<?php echo $lists['subject_gpa']; ?>" required>
											</div>
											<div class="form-group">
												<label class="form-control-label" for="attendance">English Attendance</label>
