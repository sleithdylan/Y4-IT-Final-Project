		...
		<div class="container">
			<div class="row py-5">
				<div class="col">
					...
					<p>These terms and conditions outline the rules and regulations for the use of CloseApart's Website, located
						at https://closeapart.co/.</p>

					<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
						CloseApart if you do not agree to take all of the terms and conditions stated on this page.</p>
					...
					<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
						...
						help of the <a href="https://www.privacypolicyonline.com/terms-conditions-generator/">Terms & Conditions
							Generator</a> and the <a href="https://www.generateprivacypolicy.com">Privacy Policy Generator</a>.</p>

					<br>

					<h3><strong>Cookies</strong></h3>

					<p>We employ the use of cookies. By accessing CloseApart, you agreed to use cookies in agreement with the
						CloseApart's Privacy Policy.</p>
					...
					<p>Unless otherwise stated, CloseApart and/or its licensors own the intellectual property rights for all
						material on CloseApart. All intellectual property rights are reserved. You may access this from CloseApart
					...
					<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
						certain areas of the website. CloseApart does not filter, edit, publish or review Comments prior to their
						presence on the website. Comments do not reflect the views and opinions of CloseApart,its agents and/or
						affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
						extent permitted by applicable laws, CloseApart shall not be liable for the Comments or for any liability,
					...
					<p>CloseApart reserves the right to monitor all Comments and to remove any Comments which can be considered
					...
					<p>You hereby grant CloseApart a non-exclusive license to use, reproduce, edit and authorize others to use,
					...
					<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
						...
						of CloseApart; and (d) the link is in the context of general resource information.</p>
					...
					<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
						website, you must inform us by sending an e-mail to CloseApart. Please include your name, your organization
					...
					<p>No use of CloseApart's logo or other artwork will be allowed for linking absent a trademark license
						agreement.</p>
