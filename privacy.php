		...
		<div class="container">
			<div class="row py-5">
				<div class="col">
					...
					<p>At CloseApart, accessible from https://closeapart.co/, one of our main priorities is the privacy of our
						visitors. This Privacy Policy document contains types of information that is collected and recorded by
						CloseApart and how we use it.</p>
					...
					<p>CloseApart follows a standard procedure of using log files. These files log visitors when they visit
						...
						Privacy Policy was created with the help of the <a
							href="https://www.privacypolicyonline.com/privacy-policy-generator/">Privacy Policy Generator</a> and the
					...
					<p>Like any other website, CloseApart uses 'cookies'. These cookies are used to store information including
					...
					<P>You may consult this list to find the Privacy Policy for each of the advertising partners of CloseApart.
					</p>

					<p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
						used in their respective advertisements and links that appear on CloseApart, which are sent directly to
					...
					<p>Note that CloseApart has no access to or control over these cookies that are used by third-party
						advertisers.</p>
					...
					<p>CloseApart's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
					...
					<p>CloseApart does not knowingly collect any Personal Identifiable Information from children under the age of
					...
					<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
						regards to the information that they shared and/or collect in CloseApart. This policy is not applicable to
