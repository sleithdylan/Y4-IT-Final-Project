...
<head>
	<!-- Basic Page Needs -->
	<title>Gaeilge Questions | CloseApart</title>
	<meta charset="utf-8">
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							...
							<div class="dropdown-menu shadow-none pl-5" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="../result/gaeilgeresults.php">Gaeilge</a>
							</div>
						</li>
						<li class="nav-item">
							<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
					...
					<div class="card">
						<div class="card-header bg-transparent">
							<div class="d-flex justify-content-between">
									<h3 class="mb-0">Gaeilge Quiz Questions</h3>
								...
								<table id="sorttable" class="table align-items-center table-flush hover stripe" style="border: none;">
									...
									<tbody>
										...
										?>
											...
											<tr class="pb-2">
												<td><?php echo $mcq["gaeilge_quiz_id"]; ?></td>
												<td>
												...
												<td>
												<a href="editquestion.php?gaeilge_quiz_id=<?php echo $mcq["gaeilge_quiz_id"]; ?>"class="px-4 py-2 mr-2 btn text-primary shadow-none"><i class='bx bxs-edit'></i> Edit</a>
												<a <a href="viewquestion.php?gaeilge_quiz_id=<?php echo $mcq["gaeilge_quiz_id"]; ?>"class="px-4 py-2 mr-2 btn text-danger shadow-none"><i class='bx bxs-trash'></i> Delete</a>
												</td>
										    </tr>
                                                    <?php 
                                                    }
