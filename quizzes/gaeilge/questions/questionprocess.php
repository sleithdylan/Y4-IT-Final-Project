...
public function add_mcq()
{
    ...
    try
    {
        ...
        $insertQuery = "INSERT INTO `GaeilgeQuiz` ";
...
public function update_mcq()
{
    ...
    $mcq["answer_four"] = $_POST["answer_four"];        
    $mcq["correct_answer"] = $_POST["correct_answer"];
    $mcq["gaeilge_quiz_id"] = $_POST["gaeilge_quiz_id"];
    ...
    try
    {
        ...
        $updateQuery = "UPDATE `GaeilgeQuiz` SET ";
        ...
        $updateQuery .= " WHERE `gaeilge_quiz_id` = :gaeilge_quiz_id ; ";
...
public function get_mcqs()
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `GaeilgeQuiz` ORDER BY gaeilge_quiz_id DESC ;";
...
public function get_mcq($mcqid)
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `GaeilgeQuiz` WHERE `gaeilge_quiz_id`= '{$mcqid}' LIMIT 1;";
...
{
    $mcq["gaeilge_quiz_id"] = $_GET["gaeilge_quiz_id"];
    ...
    try
    {
        ...
        $deleteQuery = "DELETE FROM `GaeilgeQuiz` WHERE `gaeilge_quiz_id` = :gaeilge_quiz_id ; ";
