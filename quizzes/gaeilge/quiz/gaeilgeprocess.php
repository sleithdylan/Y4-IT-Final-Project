...
public function get_mcq_ids()
{
    try
    {
        ...
        $selectQuery = "SELECT `gaeilge_quiz_id` FROM `GaeilgeQuiz`;";
        ...
        {
            $mcq_ids[] = $mcq_id_array["gaeilge_quiz_id"];            
        }
        return $mcq_ids;
    }
...
public function get_mcqs($mcqids)
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `GaeilgeQuiz` WHERE `gaeilge_quiz_id` IN ({$mcqids});";
