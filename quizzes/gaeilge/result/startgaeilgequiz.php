...
if(isset($_POST["startQuizBtn"]))
{
    ...
    header("location: ../quiz/gaeilge.php");
    exit;
}
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header text-center bg-transparent">
							<h1 class="display-3">Gaeilge Quiz</h1>
						</div>
						<div class="card-body text-center">
							<h2>Test your Gaeilge Knowledge</h2>
							<p>This is a multiple choice quiz to test your knowledge about gaeilge</p>
