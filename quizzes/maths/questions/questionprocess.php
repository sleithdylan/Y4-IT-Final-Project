...
public function add_mcq()
{
    ...
    try
    {
        ...
        $insertQuery = "INSERT INTO `MathsQuiz` ";
...
public function update_mcq()
{
    ...
    $mcq["answer_four"] = $_POST["answer_four"];        
    $mcq["correct_answer"] = $_POST["correct_answer"];
    $mcq["maths_quiz_id"] = $_POST["maths_quiz_id"];
    ...
    try
    {
        ...
        $updateQuery = "UPDATE `MathsQuiz` SET ";
        ...
        $updateQuery .= " WHERE `maths_quiz_id` = :maths_quiz_id ; ";
...
public function get_mcqs()
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `MathsQuiz` ORDER BY maths_quiz_id DESC ;";
...
public function get_mcq($mcqid)
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `MathsQuiz` WHERE `maths_quiz_id`= '{$mcqid}' LIMIT 1;";
...
{
    $mcq["maths_quiz_id"] = $_GET["maths_quiz_id"];
    ...
    try
    {
        ...
        $deleteQuery = "DELETE FROM `MathsQuiz` WHERE `maths_quiz_id` = :maths_quiz_id ; ";
