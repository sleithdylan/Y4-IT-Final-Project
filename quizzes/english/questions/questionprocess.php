...
public function add_mcq()
{
    ...
    try
    {
        ...
        $insertQuery = "INSERT INTO `EnglishQuiz` ";
...
public function update_mcq()
{
    ...
    $mcq["answer_four"] = $_POST["answer_four"];        
    $mcq["correct_answer"] = $_POST["correct_answer"];
    $mcq["english_quiz_id"] = $_POST["english_quiz_id"];
    ...
    try
    {
        ...
        $updateQuery = "UPDATE `EnglishQuiz` SET ";
        ...
        $updateQuery .= " WHERE `english_quiz_id` = :english_quiz_id ; ";
...
public function get_mcqs()
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `EnglishQuiz` ORDER BY english_quiz_id DESC ;";
...
public function get_mcq($mcqid)
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `EnglishQuiz` WHERE `english_quiz_id`= '{$mcqid}' LIMIT 1;";
...
{
    $mcq["english_quiz_id"] = $_GET["english_quiz_id"];
    ...
    try
    {
        ...
        $deleteQuery = "DELETE FROM `EnglishQuiz` WHERE `english_quiz_id` = :english_quiz_id ; ";
