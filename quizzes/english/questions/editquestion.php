...
$mcq = NULL;
if(isset($_GET['english_quiz_id']))
{
    $mcq = $mcqObject->get_mcq($_GET["english_quiz_id"]);    
}
...
<head>
	<!-- Basic Page Needs -->
	<title>Edit English Question | CloseApart</title>
	<meta charset="utf-8">
					...
					<div class="card">
						<div class="card-header bg-transparent">
							<div class="row align-items-center">
								<div class="col">
									<h3 class="mb-0">Update English Quiz Question</h3>
								</div>
							</div>
						</div>
						<div class="card-body">
							...
							<form action="editquestion.php" method="post">
                                <div class="form-group">
                                    <input type="hidden" name="english_quiz_id" value="<?php echo $mcq["english_quiz_id"]; ?>" />
