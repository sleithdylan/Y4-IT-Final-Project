...
$english_result_marks = NULL;
foreach($answers as $answer) {
    if($answer == 1){
        $english_result_marks += 1;
    }
}
...
if(isset($_POST["saveResultBtn"])){
    ...
    $resultObj->add_result($english_result_marks, $student_fullname);
}

require_once("../quiz/englishprocess.php");
...
<head>
	<!-- Basic Page Needs -->
	<title>English Quiz | CloseApart</title>
	<meta charset="utf-8">
					...
					<ul class="navbar-nav">
						<li class="nav-item">
							...
							<div class="dropdown-menu shadow-none pl-5" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="../result/startenglishquiz.php">English</a>
											...
											<div class="single-chart">
												<svg viewBox="0 0 36 36" class="circular-chart blue">
													<path class="circle-bg" d="M18 2.0845
															...
															a 15.9155 15.9155 0 0 1 0 -31.831" />
													<path class="circle" stroke-dasharray=" <?php echo $english_result_marks*10 ;?> , 100" d="M18 2.0845
															a 15.9155 15.9155 0 0 1 0 31.831
															a 15.9155 15.9155 0 0 1 0 -31.831" />
													<text x="18" y="20.35" class="percentage"> <?php echo $english_result_marks*10 ;?> % </text>
												</svg>
											</div>
										</div>
										<h2 class="display-2">You are Done!</h2>
										<p>Congrats! You have completed the quiz</p>
										<p>Your final score is <?php echo $english_result_marks ;?>/10</p>
