...
<head>
	<!-- Basic Page Needs -->
	<title>Add Geography Question | CloseApart</title>
	<meta charset="utf-8">
					...
					<div class="card">
						<div class="card-header bg-transparent">
							<div class="row align-items-center">
								<div class="col">
									<h3 class="mb-0">Add Geography Quiz Question</h3>
								</div>
							</div>
						</div>
						<div class="card-body">
							...
							<form action="#" method="post">
								...
								<div class="form-group form-row d-flex align-items-end">
									<div class="form-control-label col-md-6">
										...
										<input type="text" class="form-control" name="answer_one" placeholder="Answer one" required>
									</div>
								...
								<div class="form-group form-row d-flex align-items-end">
									<div class="form-control-label col-md-6">
										...
										<input type="text" class="form-control" name="answer_two" placeholder="Answer two" required>
									</div>
									<div class="form-check col-md-6 pl-5">
								...
								<div class="form-group form-row d-flex align-items-end">
									<div class="form-control-label col-md-6">
										...
										<input type="text" class="form-control" name="answer_four" placeholder="Answer four" required>
									</div>
									<div class="form-check col-md-6 pl-5">
