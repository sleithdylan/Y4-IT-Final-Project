...
{
    $mcq = $mcqObject->get_mcq($_GET["geography_quiz_id"]);    
}
...
<head>
	<!-- Basic Page Needs -->
	<title>Edit Geography Question | CloseApart</title>
	<meta charset="utf-8">
					...
					<div class="card">
						<div class="card-header bg-transparent">
							<div class="row align-items-center">
								<div class="col">
									<h3 class="mb-0">Update Geography Quiz Question</h3>
								</div>
							</div>
						</div>
						<div class="card-body">
              ...
              ?>
							<form action="editquestion.php" method="post">
								<div class="form-group">
									<input type="hidden" name="geography_quiz_id" value="<?php echo $mcq["geography_quiz_id"]; ?>" />
