...
$mcqObject = new MCQ();
if(isset($_GET["geography_quiz_id"]))
{
...
<head>
	<!-- Basic Page Needs -->
	<title>Geography Questions | CloseApart</title>
	<meta charset="utf-8">
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							...
							<div class="dropdown-menu shadow-none pl-5" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="./viewquestion.php">Geography</a>
						...
						<li class="nav-item">
							...
							<div class="dropdown-menu shadow-none pl-5" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="../result/geographyresults.php">Geography</a>
								...
								<table id="sorttable" class="table align-items-center table-flush hover stripe" style="border: none;">
									...
									<tbody>
										...
										?>
											...
											<tr class="pb-2">
												<td><?php echo $mcq["geography_quiz_id"]; ?></td>
												<td>
												...
												<td>
												<a href="editquestion.php?geography_quiz_id=<?php echo $mcq["geography_quiz_id"]; ?>"class="px-4 py-2 mr-2 btn text-primary shadow-none"><i class='bx bxs-edit'></i> Edit</a>
												<a <a href="viewquestion.php?geography_quiz_id=<?php echo $mcq["geography_quiz_id"]; ?>"class="px-4 py-2 mr-2 btn text-danger shadow-none"><i class='bx bxs-trash'></i> Delete</a>
												</td>
										    </tr>
                                                    <?php 
                                                    }
