...
public function add_mcq()
{
    ...
    try
    {
        ...
        $insertQuery = "INSERT INTO `GeographyQuiz` ";
...
public function update_mcq()
{
    ...
    $mcq["answer_four"] = $_POST["answer_four"];        
    $mcq["correct_answer"] = $_POST["correct_answer"];
    $mcq["geography_quiz_id"] = $_POST["geography_quiz_id"];
    ...
    try
    {
        ...
        $updateQuery = "UPDATE `GeographyQuiz` SET ";
        ...
        $updateQuery .= " WHERE `geography_quiz_id` = :geography_quiz_id ; ";
...
public function get_mcqs()
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `GeographyQuiz` ORDER BY geography_quiz_id DESC ;";
...
public function get_mcq($mcqid)
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `GeographyQuiz` WHERE `geography_quiz_id`= '{$mcqid}' LIMIT 1;";
...
{
    $mcq["geography_quiz_id"] = $_GET["geography_quiz_id"];
    ...
    try
    {
        ...
        $deleteQuery = "DELETE FROM `GeographyQuiz` WHERE `geography_quiz_id` = :geography_quiz_id ; ";
