...
public function get_mcq_ids()
{
    try
    {
        ...
        $selectQuery = "SELECT `geography_quiz_id` FROM `GeographyQuiz`;";
        ...
        {
            $mcq_ids[] = $mcq_id_array["geography_quiz_id"];            
        }
        return $mcq_ids;
    }
...
public function get_mcqs($mcqids)
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `GeographyQuiz` WHERE `geography_quiz_id` IN ({$mcqids});";
