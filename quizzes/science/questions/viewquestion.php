...
<head>
	<!-- Basic Page Needs -->
	<title>Science Questions | CloseApart</title>
	<meta charset="utf-8">
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							...
							<div class="dropdown-menu shadow-none pl-5" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="./viewquestion.php">Science</a>
						...
						<li class="nav-item">
							...
							<div class="dropdown-menu shadow-none pl-5" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="../result/scienceresults.php">Science</a>
					...
					<div class="card">
						<div class="card-header bg-transparent">
							<div class="d-flex justify-content-between">
									<h3 class="mb-0">Science Quiz Questions</h3>
								...
								<table id="sorttable" class="table align-items-center table-flush hover stripe" style="border: none;">
									<thead class="thead-light">
										<tr>
											...
											<th scope="col">Ans 1</th>
											<th scope="col">Ans 2</th>
											<th scope="col">Ans 3</th>
											<th scope="col">Ans 4</th>
									...
									<tbody>
										...
										?>
											...
											<tr class="pb-2">
												<td><?php echo $mcq["science_quiz_id"]; ?></td>
												<td>
												...
												<td>
												<a href="editquestion.php?science_quiz_id=<?php echo $mcq["science_quiz_id"]; ?>"class="px-4 py-2 mr-2 btn text-primary shadow-none"><i class='bx bxs-edit'></i> Edit</a>
												<a <a href="viewquestion.php?science_quiz_id=<?php echo $mcq["science_quiz_id"]; ?>"class="px-4 py-2 mr-2 btn text-danger shadow-none"><i class='bx bxs-trash'></i> Delete</a>
												</td>
										    </tr>
                                                    <?php 
                                                    }
