...
public function get_mcq_ids()
{
    try
    {
        ...
        $selectQuery = "SELECT `science_quiz_id` FROM `ScienceQuiz`;";
        ...
        {
            $mcq_ids[] = $mcq_id_array["science_quiz_id"];            
        }
        return $mcq_ids;
    }
...
public function get_mcqs($mcqids)
{
    try
    {
        ...
        $selectQuery = "SELECT * FROM `ScienceQuiz` WHERE `science_quiz_id` IN ({$mcqids});";
