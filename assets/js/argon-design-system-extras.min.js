  ...
  Layout = (function () {
    ...
    $(window).width() > 1200 &&
      ...
      $(window).on('load resize', function () {
        $('body').height() < 800 &&
          ($('body').css('min-height', '100vh'), $('#footer-main').addClass('footer-auto-bottom'));
      });
  })(),
  Charts = (function () {
    var a,
          ...
          if (void 0 !== a.data('prefix') || void 0 !== a.data('prefix')) {
            ...
            (e.options.scales.yAxes[0].ticks.callback = function (a) {
              ...
              (e.options.tooltips.callbacks.label = function (a, e) {
                ...
                return (
                  e.datasets.length > 1 &&
                    (r += '<span class="popover-body-label mr-auto">' + o + '</span>'),
                  (r += '<span class="popover-body-value">' + n + s + t + '</span>')
                );
              });
          }
        })(a, n),
            ...
            datasets: [
              {
                ...
                backgroundColor: ['#2dce89', '#11cdef', '#f5365c'],
                data: [70, 20, 10]
              }
            ]
          }
